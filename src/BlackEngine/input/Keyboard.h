...
#ifndef BLACKENGINE_KEYBOARD_H
#define BLACKENGINE_KEYBOARD_H
...
constexpr int MODIFIER_CAPS_LOCK    = 0x0010;
constexpr int MODIFIER_NUM_LOCK    = 0x0020;
...
struct KeyEvent {
  ...
  int scanCode;
  KeyAction action;
  int modifiers; // see KEY_MODIFIER constants
};

}

#endif //BLACKENGINE_KEYBOARD_H
