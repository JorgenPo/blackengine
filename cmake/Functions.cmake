...
macro(install_headers)
    file(GLOB DEPLOY_FILES_AND_DIRS "${CMAKE_SOURCE_DIR}/src")
    ...
    endforeach()
    install( FILES ${FILES_TO_DEPLOY} DESTINATION include/BlackEngine )
    install( DIRECTORY ${DIRS_TO_DEPLOY} DESTINATION include/BlackEngine )
endmacro()